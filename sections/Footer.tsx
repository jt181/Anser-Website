export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-green-950 px-5 py-10 text-white sm:px-6 sm:py-14">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(34,197,94,0.18),transparent_34%),linear-gradient(135deg,rgba(5,46,22,0),rgba(2,6,23,0.28))]" />
      ...
      <div className="relative mx-auto grid max-w-6xl gap-8 sm:gap-10 md:grid-cols-[1.2fr_0.8fr_0.8fr] md:items-start">
        ...
        <div>
          ...
          <div className="mt-4 space-y-2 text-sm leading-6 text-green-100">
        ...
        <div>
          ...
          <nav className="mt-4 grid gap-2 text-sm text-green-100">
      ...
      <div className="relative mx-auto mt-10 flex max-w-6xl flex-col gap-3 border-t border-white/10 pt-6 text-sm text-green-200 sm:flex-row sm:items-center sm:justify-between">
